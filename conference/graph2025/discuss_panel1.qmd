...
::: footer
Prepared for presentation at the GRAPH Conference, the University of St. Thomas, Houston, TX March 21 - 23, 2025
:::
...
- Potential precedent set for broader internet censorship in Hong Kong.
:::

## Judicial Independence under NSL: What is Jurisprudence?

::: {.incremental}
- Judges operate under heavy political pressure and oversight from Beijing.
...
## Comparative Law & Human Rights Implications: HK vs. China vs. the West
...
- Erosion of Hong Kong’s constitutional autonomy under "One Country, Two Systems."
:::

## Recommendations for Reform

::: {.incremental}
- Reaffirm judicial independence through strengthened constitutional rights analysis.
- Introduce legislative checks limiting broad injunctions and censorship actions.
- Encourage international oversight from UN and global legal communities.
- Mobilize private sector (e.g., global tech firms) to legally contest censorship demands.
- Foster civil society resistance through international advocacy and legal support.
:::

## Future Research Directions

::: {.incremental}
- Conduct empirical studies of NSL's judicial application and censorship effects.
- Engage in comparative research examining national security laws across jurisdictions.
- Collaborate with diasporic and exiled Hong Kong scholars to ensure independent scholarship.
- Preserve documentation and critical analysis of ongoing changes in Hong Kong’s legal system.
...
::: {.incremental}
- Examines how diasporas form political preferences through **transnational linked fate**.
- Argues that pre-migration experiences and longstanding homeland ties shape group identity.
- Employs candidate-choice conjoint experiments among Hong Kong diasporas in the US, UK, Canada, and Australia.
- Finds that homeland-related issues—especially hawkish stances toward China—dominate political decision making over domestic issues.
- Contributes novel empirical insights into how diasporas navigate trade-offs between foreign and domestic policy preferences.
:::
...
- **Identity and Politics:** Demonstrates that diasporas maintain strong bonds with their homeland despite varying levels of host country integration.
- **Methodological Innovation:** Uses a rigorous conjoint experimental design to capture multidimensional policy preferences.
- **Foreign vs. Domestic:** Reveals that even when confronted with salient domestic issues (e.g., healthcare, economy), diasporas prioritize homeland-related policies.
:::

## Analysis & Discussion (2)

::: {.incremental}
- **Pre-migration Influence:** Emphasizes the lasting impact of pre-migration political socialization on post-migration policy preferences.
...
- **Theoretical Contribution:** Challenges traditional minority politics by highlighting the transnational dimension that goes beyond racial or ethnic categorizations.
...
::: {.incremental}
- **Longitudinal Studies:** Adopt panel designs to track how diasporic political attitudes evolve over time.
- **Expanded Comparative Scope:** Include additional diaspora groups (e.g., Syrian, Venezuelan) to test the robustness of the transnational linked fate concept.
...
- **Policy Analysis:** Further explore how diasporic preferences influence host country electoral outcomes and foreign policy decisions.
- **Interdisciplinary Collaboration:** Foster research partnerships among political scientists, sociologists, and migration scholars to deepen theoretical and empirical insights.
:::
