...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-5-1.pdf}
...
## -3.6744 -1.5514 -0.1101  1.6091  4.6353 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  0.21192    1.10492   0.192     0.85    
## x            1.08041    0.09224  11.713 7.44e-10 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.379 on 18 degrees of freedom
## Multiple R-squared:  0.884,  Adjusted R-squared:  0.8776 
## F-statistic: 137.2 on 1 and 18 DF,  p-value: 7.44e-10
\end{verbatim}
...
## Weighted Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.26636 -0.61838 -0.01293  0.51368  1.61266 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  0.16737    0.80677   0.207    0.838    
## x            1.08435    0.08226  13.181  1.1e-10 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.8915 on 18 degrees of freedom
## Multiple R-squared:  0.9061, Adjusted R-squared:  0.9009 
## F-statistic: 173.7 on 1 and 18 DF,  p-value: 1.097e-10
\end{verbatim}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-6-1.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-6-2.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-6-3.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-10-1.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-11-1.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-14-1.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-18-1.pdf}
...
\includegraphics{數據編程學_files/figure-latex/unnamed-chunk-19-1.pdf}
